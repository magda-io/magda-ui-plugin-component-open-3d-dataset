...
type DatasetDataType = ExtraVisualisationSectionComponentPropsType["dataset"];
type DistributionDataType =
    ExtraVisualisationSectionComponentPropsType["dataset"]["distributions"][0];
...
const Open3dDatasetSection: ExtraVisualisationSectionComponentType = (
    props
) => {
    ...
    return (
        <div className="magda-ui-plugin-component-open-3d-dataset no-print">
            <h3 className="section-heading">Map Preview</h3>
            <p>
                Map Preview cannot preview 3D datasets. Please click the button
                to view the 3D datasets in Digital Twin.
            </p>
            <a
